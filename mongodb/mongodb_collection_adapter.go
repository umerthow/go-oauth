...
func (col *CollectionAdapter) BulkWrite(ctx context.Context, models []mongo.WriteModel, opts ...*options.BulkWriteOptions) (result *mongo.BulkWriteResult, err error) {
	result, err = col.col.BulkWrite(ctx, models, opts...)
	return
}
